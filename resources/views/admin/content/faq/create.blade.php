                    ...
                    <form action="{{ route('admin.content.faq.store') }}" method="POST" id="form">
                        ...
                        <section class="row">
                            <div class="col-12">
                                ...
                                <textarea class="form-control form-control-sm" name="question" id="question" rows="6">{{ old('question') }}</textarea>
                                @error('question')
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control form-control-sm" name="answer" id="answer" rows="6">{{ old('answer') }}</textarea>
                                @error('answer')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
